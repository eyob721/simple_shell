 ...
 * Description:
 *     - The variable `len` is used for the `strncmp` function to only compare
 *       the variable part of the environ element.
 *     - It is the number of characters between the environ element starting
 *       point and the equal sign, i.e. the length of the variable part.
 */
 ...
 *
 * Return: pointer to the copied environ
 */
